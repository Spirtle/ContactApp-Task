class ContactFormsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @contact_form.save
        ...
        format.js { render text: "window.location = '/contact_forms';" }
      else
  ...
  private
    ...
    def contact_form_params
      params.require(:contact_form).permit(:firstname, :lastname,addresses_attributes: [:address, :country,:removed],phones_attributes: [:phone,:removed])
    end
end
